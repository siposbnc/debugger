...
- 2026-06-12 — **Cyber Glacier map shipped** (v0.3 P1, map 4 of 4 — maps target met): ×1.5 Bits / 2000 ⌬ / enemyScale 1.4, latency-field hazard (first hazard that slows enemies too — positional, damageless), tank skew, 2 objectives. Meta gap certified 0% → 44%; greenfield regression clean. BALANCE.md §4 shop total corrected (16,425 ⌬ with v0.3 additions) + §5 glacier row
