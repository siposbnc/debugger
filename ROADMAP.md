...
- 2026-06-11 — Build timestamp added to the menu version tag (`v0.2.0-dev · 2026-06-11 19:20 UTC`) per user clarification — distinguishes test-server deployments while the semver sits still between releases
