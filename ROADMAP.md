...
- [ ] [P1] (S) **Meta shop depth check** — with meta now mandatory (pillar 5), verify the 9,425 ⌬ shop gives enough headroom to carry production-tier maps before v0.5 infinite levels land; revisit `linus under-scales with meta` (BALANCE.md §6) as part of it
